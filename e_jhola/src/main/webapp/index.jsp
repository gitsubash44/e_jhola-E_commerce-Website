	...
	<div id="carouselAutoplaying"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="images/scroll3.png" style="height: 550px; width: 95%;" class="d-block w-100 " alt="...">
			</div>
			<div class="carousel-item">
				<img src="images/scroll2.png" style="height: 550px; width: 95%;" class="d-block w-100 " alt="...">
			</div>
			<div class="carousel-item">
				<img src="images/scroll1.png" style="height: 550px; width: 95%;" class="d-block w-100 " alt="...">
			</div>
		</div>
				...
				<a href="viewProduct.jsp?pid=<%=productList.get(i).getProductId()%>"
					...
					<div class="card h-100">
						...
						<div class="card-body">
							...
							<div class="container text-center">
								<span class="real-price">NPR:<%=productList.get(i).getProductPriceAfterDiscount()%></span>
								&ensp;<span class="product-price">NPR:<%=productList.get(i).getProductPrice()%>
				...
				<a href="viewProduct.jsp?pid=<%=topDeals.get(i).getProductId()%>"
					...
					<div class="card h-100">
						...
						<div class="card-body">
							...
							<div class="container text-center">
								<span class="real-price">NPR:<%=topDeals.get(i).getProductPriceAfterDiscount()%></span>
								&ensp;<span class="product-price">NPR:<%=topDeals.get(i).getProductPrice()%>
